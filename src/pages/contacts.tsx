    ...
    <div className={"flex flex-col gap-20 pt-10 md:pt-20"}>
      <PageContainer>
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-20 lg:gap-6">
          ...
          <div className="p-6 bg-surface_container rounded-[8px] bg-surface-container">
            <h2 className="text-2xl font-medium mb-10 xl:mb-8">
              {t("title_2")}
            </h2>
            ...
            <div className="flex flex-col gap-20">
              ...
              <div className="flex items-center gap-6">
                <img src="/contacts/address.svg" alt="email" />
